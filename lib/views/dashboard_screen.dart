                      ...
                      children: [
                        Expanded(
                          child: StatCounterTile(
                            ...
                            suffix: '+',
                            label: 'Emergency\nMatches',
                            gradient: const [AppColors.neonRed, AppColors.neonPink],
                          ),
                        ),
                        Expanded(
                          child: StatCounterTile(
                            ...
                            suffix: '+',
                            label: 'Volunteers\nRegistered',
                            gradient: const [AppColors.neonPurple, AppColors.neonBlue],
                          ),
                        ),
                      ],
                    ),
                ...
                children: [
                  ...
                  Expanded(
                    child: GradientStatCard(
                      ...
                      colors: const [AppColors.neonGreen, AppColors.neonCyan],
                ...
                children: [
                  Expanded(
                    child: GradientStatCard(
                      ...
                      colors: const [AppColors.neonOrange, AppColors.neonRed],
                  ...
                  Expanded(
                    child: GradientStatCard(
                      ...
                      colors: const [AppColors.neonPink, AppColors.neonPurple],
